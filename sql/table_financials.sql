...
(
	...
	*/
	...
	gen_admin_expense_ratio 	numeric GENERATED ALWAYS AS (management_and_general	/NULLIF(total_expenses, '$0.00'::money)) STORED,
	fundraising_expense_ratio 	numeric GENERATED ALWAYS AS (fundraising		/NULLIF(total_expenses, '$0.00'::money)) STORED,
	gen_admin_revenue_ratio 	numeric GENERATED ALWAYS AS (management_and_general	/NULLIF(total_revenue, '$0.00'::money)) STORED,
